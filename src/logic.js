...
function check(r){
    if(r.value == ""){
        ...
        r.setAttribute('class', 'form-control is-valid tw-rounded-sm tw-outline tw-outline-1 tw-outline-slate-300 tw-border-0 focus:tw-ring-0 focus:tw-outline-2 focus:tw-outline-green-600');
        ...
        r.setAttribute('class', 'form-control is-invalid tw-rounded-sm tw-outline tw-outline-1  tw-outline-slate-300 tw-border-0 focus:tw-ring-0 focus:tw-outline-2 focus:tw-outline-pink-600');
    }
}
        ...
        for(let j=0; j < course_marks.length; j++){
            htmlContent = `
                <div class="record-row">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" class="bi bi-database tw-fill-project-blue" viewBox="0 0 16 16">
